...
export default function CardDesc({ title, caption, status, techstack }: CardDescProps) {
  ...
  return (
    <div className="lexend-light h-95 w-90 md:h-80 md:w-200 ml-10 bg-gradient-to-b from-[#4b044c] to-[#0f0136] border-1 md:rounded-2xl rounded-b-2xl flex flex-col justify-center p-10">
